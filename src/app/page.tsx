  ...
  return (
    <div>
      ...
      <ul className="d-flex">
            ...
            <li className="cust_button"><Link className="" href="./country/italy">Italy</Link></li>
            <li className="cust_button"><Link className="" href="./country/usa">USA</Link></li>
            <li className="cust_button"><Link className="" href="./country/southkorea">Southkorea</Link></li>
